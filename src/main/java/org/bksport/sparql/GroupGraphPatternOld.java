 ...
 * 
 */
public class GroupGraphPatternOld {

  private List<Triple>                     patternList;
  private List<GroupGraphPatternOld>          optionalList;
  private List<GroupGraphPatternOld>          unionList;
  private List<Constraint>                 filterList;
  private List<String>                 filterListDate;
  private HashMap<GroupGraphPatternOld, Node> graphMap;
  ...
  public GroupGraphPatternOld() {
    patternList = new ArrayList<Triple>();
    optionalList = new ArrayList<GroupGraphPatternOld>();
    unionList = new ArrayList<GroupGraphPatternOld>();
    filterList = new ArrayList<Constraint>();
    filterListDate = new ArrayList<String>();
    graphMap = new HashMap<GroupGraphPatternOld, Node>();
  ...
  public GroupGraphPatternOld(String nameGraph) {
	    patternList = new ArrayList<Triple>();
	    optionalList = new ArrayList<GroupGraphPatternOld>();
	    unionList = new ArrayList<GroupGraphPatternOld>();
	    filterList = new ArrayList<Constraint>();
  ...
  public void addOptional(GroupGraphPatternOld groupGraphPattern) {
    optionalList.add(groupGraphPattern);
  }

  public void removeOptional(GroupGraphPatternOld groupGraphPattern) {
    optionalList.remove(groupGraphPattern);
  }

  public GroupGraphPatternOld getOptional(int i) {
  ...
  public void addGraph(Node varOrIri, GroupGraphPatternOld groupGraphPattern) {
    graphMap.put(groupGraphPattern, varOrIri);
  }

  public void removeGraph(GroupGraphPatternOld groupGraphPattern) {
  ...
  public void addUnion(GroupGraphPatternOld groupGraphPattern) {
    unionList.add(groupGraphPattern);
  }

  public void removeUnion(GroupGraphPatternOld groupGraphPattern) {
    unionList.remove(groupGraphPattern);
  }

  public GroupGraphPatternOld getUnion(int i) {
